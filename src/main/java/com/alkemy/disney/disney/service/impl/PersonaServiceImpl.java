...
public class PersonaServiceImpl implements PersonaService {
    ...
    public PersonaDTO save(PersonaDTO dto) {
        Persona entity = personaMapper.personaDTOToEntity(dto);
        Persona savedEntity = personaRepository.save(entity);
    ...
    public List<PersonaDTO> getByFilters(String name, Byte age, Short weight, List<Long> movies) {
        ...
        List<Persona> entities = personaRepository.findAll(PersonaSpecification.getByFilters(filtersDTO));
    ...
    public PersonaDTO update(Long id, PersonaDTO persona) {
        ...
        Persona savedEntity = personaRepository.save(entity.get());
